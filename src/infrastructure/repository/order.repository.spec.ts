...
describe('Order repository test', () => {
  ...
  it('should update an order', async () => {
    ...
    const orderItem = new OrderItem('1', product_1.name, product_1.price, product_1.id, 2)
    ...
    order.changeItems([new OrderItem(orderItem.id, product_1.name, product_1.price, product_1.id, 3)])
  ...
  it('should find all orders', async () => {
    ...
    const orderItem1 = new OrderItem('1', product_1.name, product_1.price, product_1.id, 4)
    ...
    const orderItem2 = new OrderItem('2', product_2.name, product_2.price, product_2.id, 2)
